...
public class ShowBookInfoAction extends FBAndroidAction {
	public ShowBookInfoAction(FBReaderInterface baseActivity, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		final Intent intent =
			new Intent(BaseActivity.getActivity().getApplicationContext(), BookInfoActivity.class)
