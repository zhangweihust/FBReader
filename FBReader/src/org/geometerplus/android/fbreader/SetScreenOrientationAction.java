...
public class SetScreenOrientationAction extends FBAndroidAction {
	...
	public SetScreenOrientationAction(FBReaderInterface baseActivity, FBReaderApp fbreader, String optionValue) {
	...
	protected void run(Object ... params) {
		setOrientation(BaseActivity.getActivity(), myOptionValue);
