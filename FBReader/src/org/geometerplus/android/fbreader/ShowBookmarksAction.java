...
public class ShowBookmarksAction extends FBAndroidAction {
	public ShowBookmarksAction(FBReaderInterface baseActivity, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		final Intent internalIntent =
			new Intent(BaseActivity.getActivity().getApplicationContext(), BookmarksActivity.class);
		if (PackageUtil.canBeStarted(BaseActivity.getActivity(), externalIntent, true)) {
			try {
