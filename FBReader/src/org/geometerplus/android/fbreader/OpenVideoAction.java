...
public class OpenVideoAction extends FBAndroidAction {
	public OpenVideoAction(FBReaderInterface baseActivity, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		final int port = BaseActivity.getDataConnectionPort();
		if (port == -1) {
			UIUtil.showErrorMessage(BaseActivity.getActivity(), "videoServiceNotWorking");
			return;
		}
		...
		if (playerNotFound) {
			UIUtil.showErrorMessage(BaseActivity.getActivity(), "videoPlayerNotFound");
		}
	}
}
