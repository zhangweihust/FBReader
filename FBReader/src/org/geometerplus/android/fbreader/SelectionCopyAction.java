...
public class SelectionCopyAction extends FBAndroidAction {
	public SelectionCopyAction(FBReaderInterface baseActivity, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		final ClipboardManager clipboard =
			(ClipboardManager)BaseActivity.getActivity().getApplication().getSystemService(Application.CLIPBOARD_SERVICE);
