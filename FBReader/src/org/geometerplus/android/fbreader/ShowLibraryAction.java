...
public class ShowLibraryAction extends FBAndroidAction {
	public ShowLibraryAction(FBReaderInterface baseActivity, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		final Intent internalIntent =
			new Intent(BaseActivity.getActivity().getApplicationContext(), LibraryActivity.class);
