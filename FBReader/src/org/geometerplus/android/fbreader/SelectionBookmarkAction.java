...
public class SelectionBookmarkAction extends FBAndroidAction {
	public SelectionBookmarkAction(FBReaderInterface baseApplication, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		final Intent intent =
			new Intent(BaseActivity.getActivity().getApplicationContext(), StyleListActivity.class);
